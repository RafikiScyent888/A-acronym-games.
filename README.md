...
A free, static website for studying the 202 acronyms from the **CompTIA A+ Core 1 & 2 (1201/1202)** exam objectives — as flashcards and four study games. No build step, no dependencies, no backend. Open `index.html` or host it on GitHub Pages.
...
All 202 acronym/expansion/definition entries were extracted from `CompTIA A+ Acronyms.pdf` (included in this repo) and live in [`data/acronyms.json`](data/acronyms.json) / [`js/acronyms-data.js`](js/acronyms-data.js).

## Project structure

```
├── index.html                 # Main tile dashboard (start here)
├── data/acronyms.json         # Source data (202 entries)
├── js/
...
- Filter study sessions to "missed cards only" using the Test/Blitz review data
- Category tags (hardware, networking, security, software) to filter flashcards/games by topic
...
This project is provided as-is for personal, educational use. CompTIA and CompTIA A+ are trademarks of CompTIA, Inc. This project is an independent study aid and is not affiliated with, endorsed by, or sponsored by CompTIA.
